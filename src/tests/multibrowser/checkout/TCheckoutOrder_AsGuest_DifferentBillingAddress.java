...
/**
 * <p>
 * Test guest checkout with one variation product with color and size and VISA.
 * Uses a different address for shipping than billing. Besides that it is
 * identically to TCheckoutOrder_AsGuest.
 * </p>
 ...
 * _datasets.xml file. The configured example places orders with different cart
