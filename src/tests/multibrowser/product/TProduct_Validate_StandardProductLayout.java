 ...
 * </ul>
 */
@ScriptName("tests.us.product.TProduct_Validate_StandardProductLayout")
@TestTargets({ "FF_1500x1000","Chrome_1280x900","firefox_sl","IE11_1280x900" })
public class TProduct_Validate_StandardProductLayout extends AbstractAnnotatedScriptTestCase {
}