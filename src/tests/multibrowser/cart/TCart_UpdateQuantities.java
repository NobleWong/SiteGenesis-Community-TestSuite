...
/**
 * <p>
 * Test refresh products and calculate sums with update quantity and resort rows
 * in cart. This test needs a full desktop view of the browser, otherwise the
 * minicart won&#39;t display the total and the test will fail.
 * </p>
 ...
 * <h2 id="product-01-change-quantity-via-update-cart">Product 01 - Change
 * quantity via update cart</h2>
 * <ul>
 ...
 * </ul>
 * <h2 id="product-02-change-quantity-via-edit-dialog">Product 02 - Change
 * quantity via edit dialog</h2>
 * <ul>
 ...
 * <li>Increase product 02 quantity to random value via edit details dialog.
 * </li>
