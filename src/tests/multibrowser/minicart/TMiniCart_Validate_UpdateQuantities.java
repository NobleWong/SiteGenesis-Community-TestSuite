...
/**
 * <p>
 * Test refresh products with update quantity and resort rows in mini cart.
 * <strong>Caution:</strong> Browser window needs to be 1200 pixels wide to show
 * totals subtotal in header.
 * </p>
 ...
 * <h2 id="product-01-and-02-validate-products">Product 01 and 02 - Validate
 * products</h2>
 * <ul>
 ...
 * </ul>
 * <h2 id="product-01-and-02-change-quantities">Product 01 and 02 - Change
 * quantities</h2>
 * <ul>
 ...
 * </ul>
 * <h2 id="product-01-and-02-remove-and-rearrange-rows">Product 01 and 02 -
 * Remove and rearrange rows</h2>
 * <ul>
 ...
 * </ul>
 */
@ScriptName("tests.us.minicart.TMiniCart_Validate_UpdateQuantities")
